...
proc crypto_pwhash_bytes_max*(): cuint {.sodium_import.}
proc crypto_pwhash_bytes_min*(): cuint {.sodium_import.}
proc crypto_pwhash_memlimit_interactive*(): cuint {.sodium_import.}
proc crypto_pwhash_memlimit_max*(): cuint {.sodium_import.}
proc crypto_pwhash_memlimit_min*(): cuint {.sodium_import.}
proc crypto_pwhash_memlimit_moderate*(): cuint {.sodium_import.}
proc crypto_pwhash_memlimit_sensitive*(): cuint {.sodium_import.}
proc crypto_pwhash_opslimit_interactive*(): cuint {.sodium_import.}
proc crypto_pwhash_opslimit_max*(): cuint {.sodium_import.}
proc crypto_pwhash_opslimit_min*(): cuint {.sodium_import.}
proc crypto_pwhash_opslimit_moderate*(): cuint {.sodium_import.}
proc crypto_pwhash_opslimit_sensitive*(): cuint {.sodium_import.}
proc crypto_pwhash_passwd_max*(): cuint {.sodium_import.}
proc crypto_pwhash_passwd_min*(): cuint {.sodium_import.}

...
proc crypto_box_seedbytes*(): uint {.sodium_import.}
...
proc crypto_pwhash_bytes_max*(): uint {.sodium_import.}
proc crypto_pwhash_bytes_min*(): uint {.sodium_import.}
proc crypto_pwhash_memlimit_interactive*(): uint {.sodium_import.}
proc crypto_pwhash_memlimit_max*(): uint {.sodium_import.}
proc crypto_pwhash_memlimit_min*(): uint {.sodium_import.}
proc crypto_pwhash_memlimit_moderate*(): uint {.sodium_import.}
proc crypto_pwhash_memlimit_sensitive*(): uint {.sodium_import.}
proc crypto_pwhash_opslimit_interactive*(): uint {.sodium_import.}
proc crypto_pwhash_opslimit_max*(): uint {.sodium_import.}
proc crypto_pwhash_opslimit_min*(): uint {.sodium_import.}
proc crypto_pwhash_opslimit_moderate*(): uint {.sodium_import.}
proc crypto_pwhash_opslimit_sensitive*(): uint {.sodium_import.}
proc crypto_pwhash_passwd_max*(): uint {.sodium_import.}
proc crypto_pwhash_passwd_min*(): uint {.sodium_import.}
proc crypto_pwhash_saltbytes*(): uint {.sodium_import.}
proc crypto_pwhash_scryptsalsa208sha256_saltbytes*(): uint {.sodium_import.}
proc crypto_pwhash_scryptsalsa208sha256_strbytes*(): uint {.sodium_import.}
proc crypto_pwhash_strbytes*(): uint {.sodium_import.}
